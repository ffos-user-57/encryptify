...
<body>
  ...
  <div class="w3-display-container w3-grayscale-min" id="home">
    <div class="padx w3-text-black">
      <h3 class="">Pretvori više lozinki u hasheve</h3>
        <p>Unesite lozinke (ili riječi) razdvojene zarezom (bez razmaka) :</p>
        <form action="bulk.php" method="post">
        <textarea type="text" name="bulk" style="width:80%;height:150px;" > </textarea><br><br />
        <button type="submit" class="w3-button w3-green w3-padding-medium w3-medium" > Pretvori </button>
        </form>
    <div class="result"> 
        <p> MD5 : <br/>  <b> <?php echo $ret2 ?> </b> </p> 
        <p> SHA1 : <br/> <b> <?php echo $ret ?> </b> </p> 
        <br/>
        <p> Ovaj konverter je napravljen za liste riječi/lozinke razdvojene zarezom.<br/>Za individualno pretvaranje (jedna riječ/lozinka) posjetite <a href="./index.php"> Početnu stranicu </a><br/><br/></p>
    </div>
  </div>
