...
if (!empty($_POST))
{
    if (isset($_POST['bulkMD5']) ) {
        //md5 enc
        $str = $_POST['bulkMD5'];
        $str_arr = explode (",", $_POST['bulkMD5']); 
...
<div class="navbar">
    ...
    <div class="section">
        <br />
        <h2>Bulk MD5 encrypt</h2>
        <p>Enter your passwords seperated by a comma (no spaces) :</p>
        <form action="bulkmd5.php" method="post">
        <textarea type="text" name="bulkMD5" style="width:80%;height:150px;" > </textarea><br><br />
        <input type="submit">
        </form>
        <br />
        <br />
